...
(function () {
  angular
    ...
    .factory('newfeaturesservice', newfeaturesservice);

  newfeaturesservice.$inject = ['localstorageservice'];

  function newfeaturesservice(localstorageservice) {
    return {
      show: show
    };

    /**
     * Show the new features if the user has not seen it before
